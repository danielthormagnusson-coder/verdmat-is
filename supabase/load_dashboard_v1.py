...
IMPORT_SPEC = [
    ("ats",
     ...
     None),
    ("ats_by_quarter",
     EXPORTS / "ats_lookup_by_quarter.csv",
     "ats_lookup_by_quarter",
     ("canonical_code", "region_tier", "quarter", "n_pairs",
      "median_log_ratio", "dispersion_sd", "dispersion_mad",
      "above_list_rate", "heat_bucket", "data_quality",
      "p33", "p67", "n_qtrs_stable")),
    ("llm",
